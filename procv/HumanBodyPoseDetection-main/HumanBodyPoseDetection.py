...
cap = cv2.VideoCapture("c:/Users/aswin/Downloads/HumanBodyPoseDetection-main/HumanBodyPoseDetection-main/Original Stayin Alive dance - Aubrey Fisher x Vik.mp4")
...
while True:
    ...
    if img is None:
         ...
         img = cv2.resize(img, dsize=(300, 600))
